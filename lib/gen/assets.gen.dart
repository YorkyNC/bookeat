...
class $AssetsAppImagesGen {
  ...
  /// File path: assets/app_images/barcode.png
  AssetGenImage get barcode =>
      const AssetGenImage('assets/app_images/barcode.png');
  ...
  /// File path: assets/app_images/example1.png
  AssetGenImage get example1 =>
      const AssetGenImage('assets/app_images/example1.png');

  /// File path: assets/app_images/example2.jpg
  AssetGenImage get example2 =>
      const AssetGenImage('assets/app_images/example2.jpg');

  /// File path: assets/app_images/example3.jpg
  AssetGenImage get example3 =>
      const AssetGenImage('assets/app_images/example3.jpg');
  ...
  /// File path: assets/app_images/logo_notification.svg
  String get logoNotification => 'assets/app_images/logo_notification.svg';

  /// File path: assets/app_images/my_point_second.svg
  String get myPointSecond => 'assets/app_images/my_point_second.svg';

  /// File path: assets/app_images/orders_empty.png
  AssetGenImage get ordersEmpty =>
      const AssetGenImage('assets/app_images/orders_empty.png');

  /// File path: assets/app_images/packages.svg
  String get packages => 'assets/app_images/packages.svg';
  ...
  /// File path: assets/app_images/stocks.svg
  String get stocks => 'assets/app_images/stocks.svg';

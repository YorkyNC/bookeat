...
class ThrottleException extends DomainException {
  ThrottleException({required super.message}) : super(stackTrace: null);
}

class ServerException extends DomainException {
  ServerException({super.stackTrace}) : super(message: 'We are working on it. Please try again later.');
}

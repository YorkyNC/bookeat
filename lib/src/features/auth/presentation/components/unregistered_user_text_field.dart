...
class UnregisteredUserTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Form(
      key: formKey,
      child: TextFormField(
        maxLines: helper == true ? null : 1,
        maxLength: helper == true ? 1000 : null,
        maxLengthEnforcement: helper == true ? MaxLengthEnforcement.enforced : MaxLengthEnforcement.none,
        ...
        decoration: InputDecoration(
          ...
          hintText: hintText,
          hintStyle: context.typography.bodyLmedium.copyWith(

...
class ForgotPassword extends AuthorizationEvent {
  final ForgotPasswordRequest request;
  ForgotPassword(this.request);
}

class ResetPassword extends AuthorizationEvent {
...
class TestRefreshToken extends AuthorizationEvent {
  TestRefreshToken();
}

...
/// @nodoc
abstract class _$$OtpEntityImplCopyWith<$Res>
    implements $OtpEntityCopyWith<$Res> {
  factory _$$OtpEntityImplCopyWith(
          _$OtpEntityImpl value, $Res Function(_$OtpEntityImpl) then) =
      __$$OtpEntityImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String pinId, String to, String ncStatus, String smsStatus});
}
...
/// @nodoc
class __$$OtpEntityImplCopyWithImpl<$Res>
    extends _$OtpEntityCopyWithImpl<$Res, _$OtpEntityImpl>
    implements _$$OtpEntityImplCopyWith<$Res> {
  __$$OtpEntityImplCopyWithImpl(
      _$OtpEntityImpl _value, $Res Function(_$OtpEntityImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$OtpEntityImpl implements _OtpEntity {
  const _$OtpEntityImpl(
      {required this.pinId,
      required this.to,
      required this.ncStatus,
      required this.smsStatus});

  factory _$OtpEntityImpl.fromJson(Map<String, dynamic> json) =>
      _$$OtpEntityImplFromJson(json);
  ...
  @override
  String toString() {
    return 'OtpEntity(pinId: $pinId, to: $to, ncStatus: $ncStatus, smsStatus: $smsStatus)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$OtpEntityImplCopyWith<_$OtpEntityImpl> get copyWith =>
      __$$OtpEntityImplCopyWithImpl<_$OtpEntityImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$OtpEntityImplToJson(
      this,
    );
  }
}
...
abstract class _OtpEntity implements OtpEntity {
  const factory _OtpEntity(
      ...
      required final String to,
      required final String ncStatus,
      required final String smsStatus}) = _$OtpEntityImpl;

  factory _OtpEntity.fromJson(Map<String, dynamic> json) =
      _$OtpEntityImpl.fromJson;
